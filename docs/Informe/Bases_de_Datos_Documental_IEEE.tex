...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{../Img/MapaConceptual.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{../Img/ModeloConceptual.png}}
...
\bibitem{marquez2026} \begin{sloppypar}J.~P. Márquez Ablan, \textit{amazonia-marketplace-db}. GitHub, 2026. [En línea]. Disponible en: \url{https://github.com/JotaPert/amazonia-marketplace-db}\end{sloppypar}
\bibitem{mongodb2026} MongoDB, ``Document Database,'' MongoDB, Inc. [En l\'{\i}nea]. Disponible en: \url{https://www.mongodb.com/es/resources/basics/databases/document-databases} [Accedido: Jun. 2026].
\end{thebibliography}
